    ...
    <section className="bg-hero">
      <Flex className="h-dvh max-w-[1200px] mob:flex-col tab:flex-col  mx-auto justify-between items-center">
        <Grid>
          ...
          <div className="text-xl mob:text-lg mob:text-center mob:px-4 mob:mx-auto  max-w-lg tab:text-center pb-6">The presale will be launched soon. Join Pepoleon's army to conquer all the memes.</div>
