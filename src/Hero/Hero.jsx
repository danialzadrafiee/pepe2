...
const Hero = () => {
  ...
  return (
    <section className="bg-hero">
      <Flex className="h-screen max-w-[1200px] mob:flex-col tab:flex-col  mx-auto justify-between items-center">
        <Grid>
          <Header />
          <div className="font-impact leading-[80px] mob:text-[50px] tab:text-[60px] tab:mt-48  tab:leading-[60px]  tab:mx-auto tab:text-center  tab:max-w-lg  mob:mt-32 mob:leading-[50px] mob:text-center text-[80px] mob:pb-4  tab:pb-2 pb-14">
